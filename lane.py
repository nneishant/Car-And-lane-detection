...
#canny_images = canny(lane_image)
#cropped_image = region_of_interest(canny_images)
#lines = cv2.HoughLinesP(cropped_image, 2, np.pi/180, 50, np.array([]), minLineLength=5, maxLineGap=70)
